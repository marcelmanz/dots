# Aliases auto generated by nu-alias-converter on 2025-01-03.
# Changes to this file will be overwritten.

# alias ls = eza # Ignored all alias using 'eza' command via .aliasignore
# alias ll = eza -l # Ignored all alias using 'eza' command via .aliasignore
alias cowlol = cowsay hello | lolcat
# alias lla = eza -la # Ignored all alias using 'eza' command via .aliasignore
alias cp = cp -i
alias mv = mv -i
...
# alias zkn = cd ~/notes; ~/scripts/zk-new; # Ignored alias via .aliasignore
# alias zko = cd ~/notes; nvim -c 'ZkNotes'; cd - # Ignored alias via .aliasignore
...
alias tas = ~/scripts/tmux/tmux-attach-search.sh
...
# alias gdct = git describe --tags $(git rev-list --tags --max-count 1) # Errors: Parse mismatch during operation.
...
# alias ggpull = git pull origin $(git symbolic-ref --short HEAD) # Errors: Parse mismatch during operation.
# alias ggpush = git push origin $(git symbolic-ref --short HEAD) # Errors: Parse mismatch during operation.
# alias gpsup = git push --set-upstream origin $(git symbolic-ref --short HEAD) # Errors: Parse mismatch during operation.
# alias ggsup = git branch --set-upstream-to origin $(git symbolic-ref --short HEAD) # Errors: Parse mismatch during operation.
